        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div class="setting-drawer-index-blockChecbox">
            ...
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleLayout('sidemenu')">
                <img src="https://gw.alipayobjects.com/zos/rmsportal/KDNDBbriJhLwuqMoxcAr.svg" alt="sidemenu">
                <div class="setting-drawer-index-selectIcon" v-if="layoutMode !== 'sidemenu'">
                  <a-icon type="check"/>
                </div>
              </div>
          ...
          <div :style="{ marginTop: '24px' }">
            <a-list :split="false">
              ...
              <a-list-item >
                <a-switch slot="actions" size="small" :disabled="(layoutMode === 'sidemenu')" :checked="dataFixSiderbar" @change="handleFixSiderbar" />
                <a-list-item-meta>
                  <div slot="title" :style="{ textDecoration: layoutMode === 'sidemenu' ? 'line-through' : 'unset' }">固定侧边菜单</div>
                </a-list-item-meta>
              </a-list-item>
            </a-list>
          </div>
