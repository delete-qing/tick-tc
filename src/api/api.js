...
////根路径
// const doMian = "/tick-tc/";
////图片预览请求地址
// const imgView = "http://localhost:8080/tick-tc/sys/common/view/";
...
// 部门管理
const queryDepartTreeList = (params) => getAction("/sys/sysOffice/findShopAreaTree", params);
