.<template xmlns:background-color="http://www.w3.org/1999/xhtml">
  <a-row :gutter="10" class="tick-black">
    <a-col :md="12" :sm="24">
              ...
              <a-dropdown :trigger="[this.dropTrigger]" @visibleChange="dropStatus">
                <span style="user-select: none">
                  <a-tree
                    ...
                    @expand="onExpand"
                  />
                  <!-- :expandedKeys="iExpandedKeys"  树形结构样式
      ...
      <a-card :bordered="false">
        <a-form :form="form">
          ...
          <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="教育程度">
            <a-input placeholder="请输入教育程度" v-decorator="['mobile', { initialValue: '' }]" />
          </a-form-item>
          <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="机构层级">
            <a-input placeholder="请输入机构层级" v-decorator="['address', { initialValue: '' }]" />
          </a-form-item>
...
import { httpAction, deleteAction } from '@/api/manage' //接口方法
