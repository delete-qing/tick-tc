<template>
  <div id="tick-personnel">
    <div class="all">
      <div class="tick-black">
              ...
              <a-row :gutter="24">
                ...
                <a-col :span="6">
                  <a-form-item label="姓名">
                    <a-input placeholder="请输入账号查询" v-model="queryParam.realname"></a-input>
                  </a-form-item>
                </a-col>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        ...
        department: '/sys/sysOffice/findShopAreaTree',
      },
    }
  },
  created() {
  ...
  methods: {
    loadData(arg) {
      ...
      getAction(this.url.department).then((res) => {
        this.department = res.result
        // this.department = res.result[0].children
      })
    },
    getQueryParams() {
      ...
      if (param.officeId != null) {
        param.officeId = param.officeId.value.substring(
          param.officeId.value.indexOf('@') + 1,
          param.officeId.value.length
        )
      }
